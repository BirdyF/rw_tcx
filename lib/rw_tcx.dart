  ...
  TCXModel readTCX(String contents) {
    ...
    // Search for the content of a tag 
      ...
      do {
        ...
        print('idx : ${trackPoint.index}  -- ${trackPoint.timeStamp} -- ${trackPoint.distance}');
        if (trackPoint.index == null) {
          ...
          if ((trackPoint.latitude != null) && (trackPoint.longitude != null) && (trackPoint != null)) {
...
/// from a TCX Model
/// 
void writeTCX(TCXModel tcxInfos) async {

   // Now generate a new file from rideData
    var generatedTCXFile = await _localFile;
    ...
    activityContent = activityContent +  addAttribute('Lap', 'StartTime', createTimestamp(date), lapContent);
