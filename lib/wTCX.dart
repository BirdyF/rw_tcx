...
String addTrackPoint(TrackPoint point) {
  ...
  _returnString = _returnString + addPosition(point.latitude.toString(), point.longitude.toString());
  _returnString = _returnString + addElement('AltitudeMeters', point.altitude.toString());
  _returnString = _returnString + addElement('DistanceMeters', point.distance.toString());
...
String addPosition(String latitude, String longitude) {
  ...
  returnString = returnString + '   <LatitudeDegrees>' + latitude + '</LatitudeDegrees>\n';
  returnString = returnString + '   <LongitudeDegrees>' + longitude + '</LongitudeDegrees>\n';
...
String addAttribute(String tag, String attribute,  String value, String content) {
  String returnString;
